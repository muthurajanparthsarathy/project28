...
<!DOCTYPE html>
<html lang="en" style="height:90VHvh;">
<head>
<meta charset="utf-8">
...
<body class="h-100 img-fluid" >
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" id="novalidate" novalidate>
...
<div class="container h-100 ">
      ...
      <div class="signup-form">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control" name="firstname" id="firstname" placeholder="First Name" required="required">
        <div class="valid-feedback"></div>
          <div class="invalid-feedback">Enter valid Name</div>
          </div>     
			 	<div class="col"><input type="text" class="form-control"name="lastname" id="lastname" placeholder="Last Name" required="required">
         <div class="valid-feedback"></div>
          <div class="invalid-feedback">Enter valid Name</div>
          </div>
      </div>        
      ...
      <div class="row">
          ...
          <div class="invalid-feedback">Enter Valid Password</div>    
            ...
            <div class="col"><input type="password" class="form-control" name="confirm_password" placeholder="Confirm Password" required="required">
            <div class="valid-feedback"></div>
